...
const NavButton = ({title, customFunc, icon, color, dotColor}) =>(
 <TooltipComponent content={title} position="BottomCenter">
   ...
   >
     <span style={{background: dotColor}} className="absolute inline-flex rounded-full h-2
      w-2 right-2 top-2" />
        {icon}
  ...
  return (
    ...
    <div className="flex justify-between p-2 md:mx-6 relative">
       <NavButton title="Menu"
        ...
        <div className='flex justify-center items-center p-2 md:mx-6 relative
        text-green-600 text-xl font-bold'>
        <p>J-Best Dashboard!</p>
        </div>
         ...
         <TooltipComponent content="Profile" position="BottomCenter">
           <div className="flex items-center gap-2 cursor-pointer p-1
            hover:bg-light-gray rounded-lg" onClick={() => handleClick('userProfile')}>
              ...
              <span className="text-gray-400 font-bold ml-1 text-14">J-best</span>
              </p>
